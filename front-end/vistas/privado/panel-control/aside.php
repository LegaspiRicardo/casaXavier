...
<div class="sidenav-header">
  ...
  <a class="navbar-brand m-0" href=" ../panel-control/home.php" >
    <img src="../../../material-dashboard-master/assets/img/logo.png" class="navbar-brand-img h-100" alt="main_logo">
    <span class="ms-1 font-weight-bold text-white">Casa Xavier Admin</span>
  </a>
</div>
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
  <ul class="navbar-nav">    
    ...
    <li class="nav-item">
      <a class="nav-link text-white " href="../pluma/index.php">
    ...
    <li class="nav-item">
      <a class="nav-link text-white " href="../informe/index.php">
