...
if(isset($_GET['resultado'])){
    ...
    $pluma=new Pluma();
    if(isset($_GET['id_pluma']) && isset($_GET['editar'])){
    ...
    <div class="modal-dialog">
        ...
        <div class="row mt-1 mb-2">
            ...
            <div class="col-8 ">
                ...
                <input type="text" class="form-control " id="validationCustom01" name="modelo" value="<?php echo $pluma->modelo?>" required>
            </div>
        </div>       
        ...
        <div class="col-12 mr-auto">
            ...
            <input type="text" class="form-control pb-5" id="validationCustom01" name="descripcion" value="<?php echo $pluma->descripcion?>" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <input type="text" class="form-control " id="validationCustom01" name="precio" value="<?php echo $pluma->precio?>" required>
            </div>

            <div class="col">
            <label for="validationCustom03" class="labels mb-0">Estatus</label>
            <input type="text" class="form-control" id="validationCustom03" name="estatus" value="<?php echo $pluma->estatus?>">
            </div>
        </div>
        ...
        <div class="modal-footer">
            <input type="submit" class=" col-8 btn btn-info mx-auto" value="Actualizar Pluma">
