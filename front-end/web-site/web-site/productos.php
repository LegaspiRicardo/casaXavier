...
<head>
    ...
    <title>Productos Casa Xavier</title>
...
<body>
  ...
  <!----Hide on smaller screeens---------------------------->
    <div class="d-none d-sm-block">
        <div class="row mt-4 mb-5 pb-5">
            <h2 class="col-10 mx-auto">Plumas fuente</h2>
        ...
        <div class="row mt-5 mb-5">
            <h2 class="col-10 mx-auto">Estilografos</h2>
        ...
        <div class="row mt-5 pt-5">
            <h2 class="col-10 mx-auto">Tinteros</h2>
        ...
        <div class="row mt-5 pt-5 mb-5">
            <h2 class="col-10 mx-auto">Plumas premium</h2>
