...
<body>
  ...
  <!--------------------------Primera Seccion--------------------------------------------------->
    <div class="primera-seccion col-12 pt-5 pb-5">
    ...
    <!--------------------------Conocenos-------------------------------------------------------->
    <div class="row contactanos pb-5 mb-3 mt-5 pt-3">
    ...
    <!--------------------------Colaboradores--------------------------------------------------->
    <div class="primera-seccion col-12 pt-5 pb-3 ">
      <h2 class="col-10 mx-auto borde-solido-amarillo">Nuestros Colaboradores</h2>
        <!---------Hide on bigger screens--------------------->
    ...
    <div class=" row pt-5 pb-4 d-none d-sm-block">
      <div class="col-12">
        <img src="imagenes/pluma3.jpg" class="row mx-auto imagen-contacto" alt="">
      </div>
    ...
    <div class="row pt-4 pb-4 d-sm-none ">
      <img src="imagenes/pluma3.jpg" class="col-10 mx-auto imagen-contacto" alt="">
